...
if($response){
	...
	$startPoint = $page - 1;
	echo '<a href="adopt_a_star.php">First</a>';
	if ($page > 1){
		$temp1 = $page - 1;
   		echo '<a href="adopt_a_star.php?page='.$temp1.'">Previous</a>';	
	}
	if ($page != $total_pages){
   		$temp2 = $page + 1;
		echo '<a href="adopt_a_star.php?page='.$temp2.'">Next</a>';
	}
	echo '<a href="adopt_a_star.php?page=' . $total_pages . '">Last</a>';
	echo '</div>';
}else{
